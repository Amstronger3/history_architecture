"""
Django settings for history_architecture project.
...
SECRET_KEY = 'mh27evgc!*o_)d)&t-#hp4&@w0*1fuh^e%j$cn=o_030)k!m*z'
...
WSGI_APPLICATION = 'history_architecture.wsgi.application'
