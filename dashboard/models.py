...
class Map(models.Model):
    title = models.CharField(max_length=200, unique=True)
    title_language = models.ManyToManyField(Language, related_name='map_title_language', verbose_name="Map Title Language", blank=True)
...
class Sections(models.Model):
    title = models.CharField(max_length=200, unique=True)
    title_language = models.ManyToManyField(Language, related_name='sections_title_language', verbose_name="Sections Title Language", blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class Layers(models.Model):
    title = models.CharField(max_length=200, unique=True)
    title_language = models.ManyToManyField(Language, related_name='layers_title_language', verbose_name="Layers Title Language", blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class Articles(models.Model):
    title = models.CharField(max_length=200, unique=True)
    title_language = models.ManyToManyField(Language, related_name='article_title_language', verbose_name="Article Title Language", blank=True)
    ...
    brief_description_language = models.ManyToManyField(Language, related_name='article_brief_description_language', verbose_name="Article Brief Description Language", blank=True)
    full_description = models.TextField(null=True)
    full_description_language = models.ManyToManyField(Language, related_name='article_full_description_language', verbose_name="Article Full Description Language", blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    audio_text = models.FileField(upload_to='media/audio/', validators=[validate_music_file_extension])
    audio_language = models.ManyToManyField(Language, related_name='article_audio_language', verbose_name="Article Audio Language", blank=True)
...
class Museums(models.Model):
    title = models.CharField(max_length=200, unique=True)
    title_language = models.ManyToManyField(Language, related_name='museums_title_language', verbose_name="Museums Title Language", blank=True)
    ...
    sequence = models.FloatField()
    brief_description = models.TextField(null=True)
    brief_description_language = models.ManyToManyField(Language, related_name='museums_brief_description_language', verbose_name="Museums Brief Description Language", blank=True)
    full_description = models.TextField(null=True)
    full_description_language = models.ManyToManyField(Language, related_name='museums_full_description_language', verbose_name="Museums Full Description Language", blank=True)
    audio_text = models.FileField(upload_to='media/audio/', validators=[validate_music_file_extension])
    created_at = models.DateTimeField(auto_now_add=True)
...
class Route(models.Model):
    title = models.CharField(max_length=200, unique=True)
    title_language = models.ManyToManyField(Language, related_name='route_title_language', verbose_name="Route Title Language", blank=True)
...
class Gallery(models.Model):
    ...
    brief_description_language = models.ManyToManyField(Language, related_name='galleries_brief_description_language', verbose_name="Galleries Brief Description Language", blank=True)
    sequence = models.FloatField()
